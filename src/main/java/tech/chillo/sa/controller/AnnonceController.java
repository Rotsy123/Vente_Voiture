...
public class AnnonceController {
    ...
    // public ResponseEntity<Object> createAnnonceWithDetails(@RequestBody
    // AnnonceCreationRequest request) {
    // Annonce annonceOptional =
    // this.bouquetService.createsaveAnnonceWithDetails(request);
    // return new ResponseEntity<>(annoncesService.saveAnnonces(annonceOptional),
    // HttpStatus.OK);
    // }
    ...
    // @GetMapping("/annonce")
    // public List<Annonces> getAnnoncesByPersonneId(@RequestParam("idpersonne")int
    // idpersonne){
    ...
    // @PostMapping("/update")
    // public ResponseEntity<String> updateAnnonce(@RequestParam int etat,
    // @RequestParam int idannonce) {
